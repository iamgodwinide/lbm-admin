...
function EditMessage() {
    ...
    const handleSubmit = async () => {
        try {
            ...
            const req = await makePostRequest("/edit-message", {
                title,
    ...
    const handleDelete = async() => {
        try {
            ...
            if(confirmation){
                const res = await makePostRequest(`/messages/delete/${msgid}`);
    ...
    const init = async () => {
        const res = await makeGetRequest(`/messages/find/${msgid}`);
        const data = await res.json();
        const msg = data.message[0];
        setTitle(msg.title);
        setAbout(msg.about);
        setSeriesID(msg.seriesID);
            ...
            <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
                ...
                <main>
                    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
                        <h1 className='h3 text-dark'>Edit Message</h1>
